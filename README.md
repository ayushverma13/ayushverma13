...
| Python, XML, ElementTree, openpyxl, pandas, numpy  | Creating algorithms for extracting information and transforming issuer asset data from a series of XML, PDF, and word files based on the primary input file using k-ary tree algorithms, identifying files as leaf nodes on the basis of certain mathematical operations. |
| Python, UIPath | Created multiple levels of automations that were designed for the for the securitiztion deal modelling, transforming asset data provided by the issuer, run reports in the model, and to pull out data from the offering circular to be compared to the data generated by the modeling tool, and generate a report of all the validations performed in the process. |

## Sawtooth Transaction Processor / Habric Chain Code
| Personal Project ( [Sawtooth Repository](https://github.com/ayushverma13/Hyperledger-Sawtooth-Sample) ) [Fabric Repository](https://github.com/ayushverma13/Sample-ChainCodes-Go) ) | Period of work ( 05/2021 - 06/2021 ) | 
|:---------:|:----------------------------------:|
| -- | Implemented multiple simple projects to understand the architecture of the projects under the Hyperledger umbrella, through multiple courses offered by LinuxFoundationX on edX like Introduction to Hyperledger Blockchain Technologies, Hyperledger Sawtooth for Application Developers, Udemy courses Design and develop Fabric 2.1 applications from end- to-end using GoLang & Fabric Node, Hyperledger Fabric 2.x Network Design & Setup, and the official documentations of these projects under the hyperledger umbrella to understand the development of enterprises level blockchain products. I studied about hyperledger fabric and sawtooth. | 
| | |
| -- | Task |
...
| -- | Also learnt about the Sawtooth architechture deploying single and multinode testing programs, to create and play with transaction processors for current sample projects like Sawtooth Marketplace and Simple Supply. Eventually also developed a Sawtooth Transaction processor for the same application from the study of these sample sawtooth projects.  |
